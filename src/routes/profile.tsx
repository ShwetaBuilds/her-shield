...
import { User, Bell, Shield, Users, LogOut, ChevronRight } from "lucide-react";
...
function Profile() {
  ...
  const sections = [
    ...
    { icon: Users, title: "Trusted Contacts", desc: "Manage your trust circle — currently 4 contacts." },
